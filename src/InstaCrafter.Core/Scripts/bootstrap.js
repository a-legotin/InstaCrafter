        ...
        var Collapse = function() {
            ...
            Collapse.prototype.show = function show() {
                ...
                var complete = function complete() {
                    $(_this6._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE)
            ...
            Collapse.prototype.hide = function hide() {
                ...
                var complete = function complete() {
                    ...
                    $(_this7._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE)
 ...
 */
    ...
    var Dropdown = function($) {
        ...
        $(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler)
            ...
            .on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, Dropdown.prototype.toggle).on(Event.CLICK_DATA_API,
                Selector.FORM_CHILD,
                function(e) {
                    e.stopPropagation();
                });
        ...
        var Tab = function() {
            ...
            Tab.prototype._activate = function _activate(element, container, callback) {
                ...
                var isTransitioning = callback &&
                    ...
                    (active && $(active).hasClass(ClassName.FADE) || Boolean($(container).find(Selector.FADE_CHILD)[0])
                    );
            ...
            Tab.prototype
                ._transitionComplete = function _transitionComplete(element, active, isTransitioning, callback) {
                    if (active) {
